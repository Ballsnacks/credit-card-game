...
margin = " "*8
seconds = ""
failure_words = ["Bollocks", "Bugger", "ffs", "Shite", "Damn", "Goddammit", "Gah", "Nope", "Boo", "Dagnabbit", "For goodness' sake", "Nuh-uh", "Nah", "Negative", "You almost did it", "Yea...but no", "Do you need a break?", "WOW... Thats embarassing", "No... Just no", "YOU ALMOST DID IT", "try removing distractions", "GOOD JOB you failed", "Thats okay, I remembered for you", "BEEP BOOP, wrong answer", "You cant just mash the keys and hope its right!!", "lolwut", "Losing feels bad, doesn't it", "You need a clear mind to do this", "Ok...THAT was pretty bad", "You did it! if failure was your goal", "Your better than this", "Not today criminal scum", "Sorry sport, try again", "Not very epic of you", "Not even close","$*#@!!",]#you want failure_words? we got em!
